...
export function SupportForm({
  ...
  if (done) {
    return (
      <Card className="border-good-mid bg-good-light text-center">
        ...
        <p className="mt-1 text-sm font-bold text-good">Request submitted</p>
  ...
  return (
    <Card>
      <p className="mb-2 text-xs font-bold tracking-wide text-dim uppercase">What&apos;s the issue?</p>
      ...
      <textarea
        ...
        rows={4}
        placeholder="Tell us what happened, including any amounts or dates…"
      ...
      />
      {bookingId && <p className="mb-2 text-[10px] text-dim">Linked to booking #{bookingId}</p>}
      <button
        onClick={submit}
